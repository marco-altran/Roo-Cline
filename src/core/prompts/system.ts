...
/**
 * Returns a string containing a template with intact placeholders,
 * e.g. "${supportsComputerUse ? ...}" inside it. This function does
 * not resolve the placeholders. It's meant to store and display
 * literally, letting you resolve them later (e.g. in Cline.ts).
 */
...
- When you want to modify a file, use the write_to_file tool ...
- Do not ask for more information than necessary ...
\${supportsComputerUse
	? \`- The user may ask generic non-development tasks ...\`
	: ""}
- NEVER end attempt_completion ...
- When presented with images ...
- At the end of each user message ...
- Before executing commands ...
- The user may provide feedback ...
...
/**
 * This function appends any custom instructions, plus optional .clinerules / .cursorrules content
 * that may exist in the user's project. It is not changing how the placeholders are handled.
 */
